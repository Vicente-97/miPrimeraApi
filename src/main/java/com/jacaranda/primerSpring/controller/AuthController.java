...
import com.jacaranda.primerSpring.security.JavaUtils;
import com.jacaranda.primerSpring.security.LoginCredencial;
...
public class AuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<?> authenticateUser(@RequestBody LoginCredencial loginRequest) {
		...
		String jwt = JavaUtils.generateToken(loginRequest.getUsername(), user.getEmail(), user.getRole());
