...
public class JavaUtils {
	...
	// Método que genera un token. Este método debe recibir toda la información que queremos
	...
	ACCESS_TOKEN_VALIDATY_SECONDS*1000);
	 ...
	 String token = Jwts.builder()
			 ...
			 // Al token generado le podemos añadir alguna información para que luego comprueba que
